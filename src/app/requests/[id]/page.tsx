  ...
  return (
    ...
    <div className="border rounded-lg p-5 mb-4 bg-white">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-2 mb-4">
        <h1 className="text-xl font-bold font-mono break-all">{request.reference}</h1>
        ...
        {nextStatuses.includes("Approved") && (
          <div className="flex flex-wrap gap-2 mb-3">
            <select
              ...
              className="border rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/10 w-full sm:w-auto"
            >
            ...
            {resolution === "Refund" && (
              <input
                ...
                className="border rounded px-2 py-1.5 text-sm w-full sm:w-32 focus:outline-none focus:ring-2 focus:ring-black/10"
              />
            )}
          </div>
        )}
